...
import { FormButtonToggleModule } from './form-button-toggle.module';
...
describe('FormButtonToggleComponent', () => {
  ...
  let fixture: MockedComponentFixture<FormButtonToggleComponent>;

  beforeEach(() =>
    MockBuilder(FormButtonToggleComponent, FormButtonToggleModule)
      .keep(ReactiveFormsModule)
  );
  beforeEach(() => {
    fixture = MockRender(FormButtonToggleComponent);
